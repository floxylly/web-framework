      ...
      @forelse ($movies as $movie)
        <div class="relative">
          ...
          <div class="absolute top-0 flex justify-between w-full">
            ...
            <p class="bg-white px-3 py-2 rounded-bl-lg text-lg">{{ $movie->category->name }}</p>
          </div>
          <div class="py-2">
            <h5 class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">{{ $movie->title }}
            </h5>
            <p class="font-normal text-gray-700 dark:text-gray-400">{{ Str::limit($movie->summary, 120) }}</p>
          </div>
        </div>
      @empty
        <section class="container px-4 mx-auto absolute w-full">
          <div class="flex items-center mt-6 text-center h-96">
            <div class="flex flex-col w-full max-w-sm px-4 mx-auto">
              ...
              <h1 class="mt-3 text-lg text-gray-800 dark:text-white">No movie found</h1>
              <p class="mt-2 text-gray-500 dark:text-gray-400">We couldn't find any movie that matched your search.</p>
